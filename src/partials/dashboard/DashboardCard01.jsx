...
function DashboardCard01() {
  ...
  return (
    <div className={`flex flex-col col-span-full sm:col-span-6 xl:col-span-4 shadow-md rounded-sm border border-slate-200 dark:border-slate-700 ${isHovered ? 'bg-gray-200 dark:bg-slate-800' : 'bg-gray-200'}`}
